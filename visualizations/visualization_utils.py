...
RESULTS_DIR = {
    AnalysisType.ACTIVATIONS_PATTERNS: settings.CONCAT_FMRI_ACTIVATIONS_PATTERN_RESULTS_AVG,
    AnalysisType.RELATIONAL_CODING: settings.SNR_RELATIONAL_CODING_RESULTS,
    AnalysisType.RESTING_STATE_RELATIONAL_CODING: settings.SNR_RESTING_STATE_RELATIONAL_CODING_RESULTS,
    AnalysisType.RESTING_STATE_ACTIVATIONS_PATTERNS: settings.CONCAT_RESTING_STATE_FMRI_ACTIVATIONS_PATTERN_RESULTS_AVG,
    AnalysisType.SINGLE_MOVIE_ACTIVATION: settings.FMRI_SINGLE_MOVIE_ACTIVATIONS_PATTERN_RESULTS,
    AnalysisType.MOVIE_DISTANCES: settings.MOVIE_DISTANCES_CORRELATION_ANALYSIS
